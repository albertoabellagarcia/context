...
activeEnergyExport: Energia ativa exportada por fase desde a data de início da medição. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
activeEnergyImport: Energia ativa importada, ou seja, consumida por fase desde a data de início da medição. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
...
address:   
alternateName:   
apparentEnergyExport: Energia aparente exportada por fase desde a data de início da medição. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
apparentEnergyImport: Energia aparente importada, ou seja, consumida por fase desde a data de início da medição. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
...
areaServed:   
current: Corrente elétrica. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada e pelo fio neutro: L1, L2, L3 e N.  
dataProvider:   
dateCreated:   
dateEnergyMeteringStarted: A data de início da medição de energia.  
dateModified:   
description:   
displacementPowerFactor: Fator de potência de deslocamento para cada fase. A quantidade é baseada na freqüência fundamental do sistema. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
frequency: A freqüência do circuito.  
id:   
location:   
name:   
owner:   
phaseToPhaseVoltage: TensÃ£o entre fases. Um valor para cada par de fases: fases 1 e 2 (L12), fases 2 e 3 (L32), fases 3 e 1 (L31).  
phaseVoltage: A tensão entre cada condutor de fase e o condutor de neutro. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
powerFactor: Fator de potência para cada fase. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
reactiveEnergyExport: Energia reativa de freqüência fundamental exportada por fase desde a data de início da medição. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
reactiveEnergyImport: Energia reativa de freqüência fundamental importada, ou seja, consumida por fase desde a data de início da medição. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
reactivePower: Poder reativo de freqüência fundamental. Os valores reais serão transmitidos por sub-propriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
refDevice: Relacionamento. Dispositivo(s) utilizado(s) para obter a medição.  
refTargetDevice: Relacionamento. Dispositivo(s) para o(s) qual(is) a medição foi feita.  
seeAlso:   
source:   
thdCurrent: Distorção harmônica total da corrente elétrica. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
thdVoltage: Distorção harmônica total de tensão para cada fase. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
totalActiveEnergyExport: Energia total exportada desde o início da medição (desde a "dateEnergyMeteringStarted").  
totalActiveEnergyImport: Energia total importada, ou seja, consumida desde o início da medição (desde a "dataEnergyMeteringStarted").  
totalActivePower: PotÃªncia ativa consumida (contando todas as fases)  
totalApparentEnergyExport: Energia total exportada (com relação à potência aparente) desde a data de início da medição (`dateEnergyMeteringStarted`)  
totalApparentEnergyImport: Energia total importada, ou seja, consumida (em relação à potência aparente) desde a data de início da medição (`dateEnergyMeteringStarted')  
totalApparentPower: Energia aparente consumida (contando todas as fases).  
totalDisplacementPowerFactor: Fator de potência de deslocamento, incluindo todas as fases. A quantidade é baseada na freqüência fundamental do sistema  
totalPowerFactor: Fator de potÃªncia incluindo todas as fases  
totalReactiveEnergyExport: Energia reativa de freqüência fundamental total exportada desde o início da medição (desde a "dateEnergyMeteringStarted").  
totalReactiveEnergyImport: Energia total importada, ou seja, consumida (em relação à potência reativa de freqüência fundamental) desde a data de início da medição (`dateEnergyMeteringStarted')  
totalReactivePower: PotÃªncia reativa consumida (contando todas as fases)  
type: Deve ser igual a "Medição de Três Fases".

Texto a ser incluído entre o título geral e a descrição.  
  
Descrição global: **Uma medição elétrica de um sistema que utiliza corrente alternada trifásica.**
