...
activeEnergyExport: Energia activa exportada por fase desde a data de início da contagem. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
activeEnergyImport: Energia activa importada, isto é, consumida por fase desde a data de início da contagem. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
activePower: Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
address:   
alternateName:   
apparentEnergyExport: Energia aparente exportada por fase desde a data de início da contagem. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
apparentEnergyImport: Energia aparente importada, isto é, consumida por fase desde a data de início da contagem. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
apparentPower: Potência aparente consumida por fase. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3  
areaServed:   
current: Corrente eléctrica. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada e pelo fio neutro: L1, L2, L3 e N.  
dataProvider:   
dateCreated:   
dateEnergyMeteringStarted: A data de inÃ­cio da contagem de energia.  
dateModified:   
description:   
displacementPowerFactor: Factor de potência de deslocamento para cada fase. A quantidade é baseada na frequência fundamental do sistema. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
frequency: A frequÃªncia do circuito.  
id:   
location:   
name:   
owner:   
phaseToPhaseVoltage: TensÃ£o entre fases. Um valor para cada par de fases: fases 1 e 2 (L12), fases 2 e 3 (L32), fases 3 e 1 (L31).  
phaseVoltage: A tensão entre cada fase e o condutor do neutro. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
powerFactor: Factor de potência para cada fase. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
reactiveEnergyExport: Energia reactiva de frequência fundamental exportada por fase desde a data de início da contagem. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
reactiveEnergyImport: Energia reactiva de frequência fundamental importada, ou seja, consumida por fase desde a data de início da contagem. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
reactivePower: Poder reactivo de frequência fundamental. Os valores reais serão transmitidos por subpropriedades cujos nomes serão iguais ao nome de cada uma das fases de corrente alternada: L1, L2, L3.  
refDevice: Relação. Dispositivo(s) utilizado(s) para obter a medição.  
refTargetDevice: Relação. Dispositivo(s) para o(s) qual(is) a medição foi efectuada.  
seeAlso:   
source:   
thdCurrent: Distorção harmónica total da corrente eléctrica. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
thdVoltage: Distorção harmónica total da tensão para cada fase. Os valores reais serão transmitidos por uma subpropriedade por fase de corrente alternada: L1, L2 e L3  
totalActiveEnergyExport: Energia total exportada desde o inÃ­cio da contagem (desde "dateEnergyMeteringStarted").  
totalActiveEnergyImport: Energia total importada, ou seja, consumida desde o inÃ­cio da contagem (desde "dateEnergyMeteringStarted").  
totalActivePower: PotÃªncia activa consumida (contando todas as fases)  
totalApparentEnergyExport: Energia total exportada (em relação à potência aparente) desde a data de início da contagem (`dateEnergyMeteringStarted`)  
totalApparentEnergyImport: Energia total importada, ou seja, consumida (no que diz respeito à potência aparente) desde a data de início da contagem (`dateEnergyMeteringStarted')  
totalApparentPower: PotÃªncia aparente consumida (contando todas as fases).  
totalDisplacementPowerFactor: Factor de potência de deslocamento, incluindo todas as fases. A quantidade é baseada na frequência fundamental do sistema  
totalPowerFactor: Factor de potÃªncia incluindo todas as fases  
totalReactiveEnergyExport: Energia reactiva de frequência fundamental total exportada desde o início da contagem (desde `dateEnergyMeteringStarted`).  
totalReactiveEnergyImport: Energia total importada, isto é, consumida (em relação à potência reactiva de frequência fundamental) desde a data de início da contagem (`dateEnergyMeteringStarted')  
totalReactivePower: PotÃªncia reactiva consumida (contando todas as fases)  
type: Deve ser igual a `ThreePhaseAcMeasurement'.

Texto a ser incluído entre o título global e a descrição.  
  
Descrição global: **Uma medição eléctrica de um sistema que utiliza corrente alternada trifásica.**
## Dados Descrição do modelo de propriedades


Encomendado por ordem alfabÃ©tica
...
Texto a ser incluído após a lista de propriedades
