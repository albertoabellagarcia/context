...
totalActiveEnergyImport: Całkowita importowana energia, czyli zużyta od momentu rozpoczęcia pomiarów (od `dateEnergyMeteringStarted`).  
...
Tekst, który należy zamieścić po liście właściwości
